...
# Label smoothing.
_C.MIXUP.LABEL_SMOOTH_VALUE = 0.2
...
# temporal crop shift range, enhance multi-view testing via expand context; 
_C.TEST.CONTEXT_APPEND = 0. # 代表双帧?; 
...
# Data Augmentation For the Data Info; 
_C.DATA.NUM_ENSEMBLE_VIEWS = 10
...
_C.H2O.ANNOTATION_DIR = "xxx/h2o/label_split"

_C.H2O.PAD_BACKGROUND = False

# Filenames of training samples list files.
_C.H2O.TRAIN_LISTS = ["action_train.txt"]
# Filenames of test samples list files.
_C.H2O.TEST_LISTS = ["action_val.txt"]
# If use BGR as the format of input frames.
_C.H2O.BGR = False
# Training augmentation parameters
# Whether to use color augmentation method.
_C.H2O.TRAIN_USE_COLOR_AUGMENTATION = False
# Whether to only use PCA jitter augmentation when using color augmentation
# method (otherwise combine with color jitter method).
_C.H2O.TRAIN_PCA_JITTER_ONLY = True
# Whether to do horizontal flipping during test.
_C.H2O.TEST_FORCE_FLIP = False
# Whether to use full test set for validation split.
_C.H2O.FULL_TEST_ON_VAL = False
# The name of the file to the ava label map.
_C.H2O.LABEL_MAP_FILE = "label_map.txt"
# Backend to process image, includes `pytorch` and `cv2`.
_C.H2O.IMG_PROC_BACKEND = "cv2"

# define the view;
_C.H2O.VIEW = ["cam4"]
# load the rgb or rgb256 ## different resolution of the rgb frames
_C.H2O.FRAME_FOLDER = "rgb256"  # rgb or rgb256 or rgb 448
_C.H2O.FRAME_TEMPL = "{:06d}.jpg"
# 代表视频本身的帧数;
_C.H2O.FPS = 30
# Loading the Bckground for H2O DataSet? 

# _C.H2O.BACKGROUND_CLASS = True
_C.H2O.BACKGROUND_CLASS = False
_C.H2O.FLOW_ENABLE = False

_C.H2O.NOUN_VERB = False
_C.H2O.NOUN_VERB_MAPING = 'xxx/h2o/label_split/idx_decompose.npy'
_C.H2O.NOUN_NUM = 9
_C.H2O.VERB_NUM = 12
_C.H2O.NOUN_VERB_WEIGHT=[1, 0.5, 0.5] # ORI, NOUN, VERB
# -----------------------------------------------------------------------------
# AVA Dataset options
# -----------------------------------------------------------------------------
_C.AVA = CfgNode()
